...
const packages = [
  ...
  },
  {
    name: "Reseller",
    price: "R1,999",
    priceNote: "Once-off setup · R599/month",
    description: "Get your own domain set up for you and start earning across 3 commission tiers.",
    features: [
  ...
  },
  {
    ...
    price: "R3,999",
    priceNote: "Once-off setup · R899/month",
    description: "Full white-glove setup with a custom website, 5-tier commissions, and leads from paid campaigns.",
    features: [
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px", marginBottom: "80px" }}>
          {packages.map((pkg, i) => (
            ...
            >
              ...
              <a
                href="https://masakheportal.co.za/partner/register"
                target="_blank"
